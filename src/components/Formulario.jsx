        ...
        <div className="container is-max-tablet">
            ...
            <form onSubmit={handleSubmit}>
                <div className="field m-4">
                    ...
                    <div className="control">
                        <input
                            className={`input ${nombreValido ? "is-success" : "is-danger"}`}
                ...
                <div className="field m-4">
                    ...
                    <div className="control">
                        <input
                            className={`input ${edadValido ? "is-success" : "is-danger"}`}
                ...
                <div className="field m-4">
                    ...
                    <div className="control">
                        <div className={`select ${pokemonValido ? "is-success" : "is-danger"}`}>
                            <select id="pokemon" value={usuarioDatos.pokemon} onChange={handleChangePokemon}>
